            ...
            <div class="col-md-12">
                <div class="block text-center">
                    <div class="footer-logo">
                        <img src="images/footer-logoes.png" alt="logo" class="img-fluid">
                    </div>
        ...
        <div class="row">
            <div class="col-md-6 align-self-center">
                <div class="copyright-text">
                    <p>
                        <a href="index.html">Simpeg MBKM</a>
                        &copy; 2022, Designed &amp; Developed by : <br>
                        Ahmad Romadhani MSIB Fullstack Developer PT-NCI
                    </p>
                </div>
            </div>
            <div class="col-md-6">
